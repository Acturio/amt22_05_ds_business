...
knitr::include_graphics("img/05-ml-lineal/5-2-1-ajuste-lineal.svg")
```
...
knitr::include_graphics("img/05-ml-lineal/5-2-7-1-forward-selection.png")
```
...
```{r, fig.align='center', out.height='400pt', out.width='350pt', echo=F, include=TRUE}
knitr::include_graphics("img/05-ml-lineal/5-2-7-2-backward-selection.png")
```
